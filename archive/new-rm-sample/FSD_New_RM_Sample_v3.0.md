...
| **3.0** | **Apr 2026**  | **Tim ICT**     | **Pembahasan detail per accordion, per step, dengan CRUD operation, LOV workflow, dan screenshot UI** |
...
| Net Weight  | `netWeight`                      | Number    | Ya           | Numeric, > 0               | Berat bersih sample yang diterima     |
...
- UOM wajib diisi, karena berkaitan dengan Net Weight
...
*Dokumen ini dibuat berdasarkan analisis kode sumber aktual oleh tim ICT — versi 3.0 mencakup detail per section UI beserta screenshot dan operasi CRUD.*
