...
=========================
Pipeline untuk membangun FSD Item Spec RM v1.0 format DOCX.
...
MD_SRC     = os.path.join(SCRIPT_DIR, 'FSD_ItemSpec_RM_v1.0.md')
MD_TMP     = os.path.join(SCRIPT_DIR, '_tmp_itemspec_rm_processed.md')
DOCX_OUT   = os.path.join(SCRIPT_DIR, 'FSD_ItemSpec_RM_v1.0.docx')
...
def step1_render_diagrams(md_content: str):
    ...
    for i, match in enumerate(blocks):
        ...
        if 'CreateDoc' in code and 'Registered' in code and 'flowchart TD' in code:
...
def step2_preprocess_markdown():
    ...
    def replace_mermaid(m):
        ...
        if 'CreateDoc' in code and 'Registered' in code and 'flowchart TD' in code:
            png     = FLOW_MAIN_PNG
            caption = 'Business Flow Diagram – Item Spec RM'
        elif 'flowchart LR' in code and 'Creator' in code and 'WaitApproval' in code:
...
if __name__ == '__main__':
    print('=' * 65)
    print('  BUILD START: FSD Item Spec RM v1.0')
